...
const readGatilhosConfig = (clientConfigPath) => {
...
export const processTriggers = async (client, targetNumber, messagePart, __dirname // Pode ser necessário passar __dirname ou o caminho base do projeto
) => {
