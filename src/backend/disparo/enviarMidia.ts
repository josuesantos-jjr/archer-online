...
export const sendImage = async (client: any, chatId: string, filePath: string, caption: string = '', messageId?: string) => {
  try {
...
export const sendPtt = async (client: any, chatId: string, filePath: string) => {
  try {
...
export const sendVideo = async (client: any, chatId: string, filePath: string, caption: string = '') => {
  try {
...
export const sendFile = async (client: any, chatId: string, filePath: string, caption: string = '') => {
  try {
